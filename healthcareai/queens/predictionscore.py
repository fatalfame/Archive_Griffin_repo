...
def main():
    ...
    #
    df = pd.read_sql(
            sql="""select CaseID, SchedulingStatusCD,SchedulingStatusDSC,PredictedProbNBR, Predicted, Actual
            ...
            WHEN s.schedulingStatusDSC = 'Completed' THEN 0 END AS Actual,
            CASE WHEN PredictedProbNBR >= 0.10 THEN 1 ELSE 0 END AS Predicted,
